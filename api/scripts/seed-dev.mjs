...
putSheet('dictApps', [
  {k:'b',id:'browser',nm:'ATOMIKA Browser',path:'modules/browser.html?v=2026051603',ico:'◎',desc:'Low Data Rate Quantum Entangled Transit Environment',w:1180,h:820},
  ...
  {k:'x',id:'bipac',nm:'LMI Terminal',path:'modules/bipac.html?v=2026051607',ico:'>_',desc:'Command shell for module discovery, descriptions, install, and launch',w:980,h:680},
