(async function(){
  const runtime=window.LMI_RUNTIME={user:null,session:null,apps:[]};
  ...
  window.LMI_DESKTOP={
    ...
    saveWindow(id,data){const l=getLayout(); l[id]=Object.assign({},l[id]||{},data); saveLayout(l);},
