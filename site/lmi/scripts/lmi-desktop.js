(async function(){
  ...
  function ensureCoreUtilityApps(apps){
    ...
    const utilityApps = [{
      ...
      title:'LMI Terminal',
      icon:'>_',
      module:'modules/bipac.html?v=2026051607',
      url:'modules/bipac.html?v=2026051607',
  ...
  const MODULE_PATH_OVERRIDES={
    bipac:'modules/bipac.html?v=2026051607',
